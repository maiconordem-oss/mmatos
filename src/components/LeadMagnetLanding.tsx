...
export const leadMagnetLandings: Record<string, LeadMagnetLandingConfig> = {
  "manual-pericia": {
    ...
    metaTitle: "Manual da Pericia Medica | Maicon Matos",
    badge: "Material Gratuito - Pericia Medica",
    heroLines: ["Manual da", "Pericia Medica", "Previdenciaria"],
    heroSub: "O guia que o INSS nao quer que voce leia antes de entrar na sala de pericia.",
    painTitle: "Voce esta nessa situacao?",
    pains: [
      "Sua pericia ja esta marcada e voce nao sabe o que levar ou como se comportar",
      "O INSS negou seu beneficio apos uma pericia que durou menos de 5 minutos",
      "Voce nao sabe quais sao seus direitos dentro da sala de pericia",
      "Nao sabe o que fazer depois da negativa e tem medo de perder o prazo",
    ],
    sectionLabel: "O que esta dentro do material",
    sectionTitle: "Conteudo que o INSS",
    sectionHighlight: "nao te conta.",
    items: [
      "Antes da pericia: documentos, laudos e preparacao",
      "Durante a pericia: como responder sem se prejudicar",
      "Depois da pericia: aprovado, negado e proximos passos",
      "Seus direitos dentro da sala de pericia",
    ],
    questions: [
      { question: "Sua pericia ja esta marcada?", options: ["Sim, ja tenho data", "Ainda nao marquei", "Ja fiz e fui negado"] },
      { question: "Qual e sua maior duvida sobre a pericia?", options: ["O que levar", "Como me comportar", "O que fazer se negar"] },
    ],
    whatsappTitle: "Para qual WhatsApp envio seu Manual da Pericia?",
    keyword: "BOA SORTE",
    footerProduct: "este manual",
  },
  "guia-recurso": {
    slug: "guia-recurso",
    title: "Guia do Recurso - Beneficio Negado",
    metaTitle: "Guia do Recurso - Beneficio Negado | Maicon Matos",
    badge: "Material Gratuito - Beneficio Negado",
    heroLines: ["Guia do", "Recurso", "Beneficio Negado"],
    heroSub: "O INSS disse nao. Mas a ultima palavra ainda nao foi dada.",
    painTitle: "Voce esta nessa situacao?",
    pains: [
      "O INSS negou seu beneficio e voce nao sabe o que fazer",
      "Tem medo de perder o prazo sem saber como contar",
      "Recebeu uma carta cheia de juridiques que nao entendeu nada",
      "Nao sabe se vale recorrer ou ja ir direto pra Justica",
    ],
    sectionLabel: "O que esta dentro do material",
    sectionTitle: "Conteudo que o INSS",
    sectionHighlight: "nao te conta.",
    items: [
      ...
      "Recurso ou Justica: qual vale mais no seu caso",
      "O passo a passo do zero ate o protocolo",
    ],
    questions: [
      { question: "Quando o INSS negou seu beneficio?", options: ["Nos ultimos 30 dias", "Ha mais de 30 dias", "Ainda nao fui negado"] },
      { question: "Qual beneficio foi negado?", options: ["Auxilio-doenca", "Aposentadoria", "BPC/LOAS", "Outro"] },
    ],
  ...
  "guia-aposentadoria": {
    ...
    heroSub: "Antes de dar entrada, leia isso. Muita gente perde centenas de reais por mes por nao saber.",
    painTitle: "Voce esta nessa situacao?",
    pains: [
      "Nao sabe se ja tem direito ou quanto tempo ainda falta",
      "Tem medo de escolher a regra errada e receber menos do que merece",
      "Nao sabe o que juntar ou como dar entrada pelo Meu INSS",
      "Acha que ja tem direito mas ainda nao deu entrada e esta perdendo dinheiro",
    ],
    sectionLabel: "O que esta dentro do material",
    sectionTitle: "Conteudo que o INSS",
    sectionHighlight: "nao te conta.",
    items: [
      "Sua regra: qual das 4 te da o maior beneficio",
      "Quanto voce vai receber e o calculo que o INSS nao explica",
      "O que juntar e o erro que atrasa o pedido por meses",
      "Como dar entrada sem sair de casa e sem perder tempo",
      "O que nao fazer: erros que custam dinheiro todo mes",
    ],
    questions: [
      { question: "Qual e sua situacao hoje?", options: ["Acho que ja tenho direito", "Falta pouco tempo", "Quero me planejar"] },
      { question: "Voce e...", options: ["Empregado CLT", "Autonomo / MEI", "Ja aposentado parcialmente"] },
    ],
  ...
  "guia-auxilio": {
    slug: "guia-auxilio",
    title: "Guia do Auxilio Doenca INSS",
    metaTitle: "Guia do Auxilio Doenca | Maicon Matos",
    badge: "Material Gratuito - Auxilio Doenca",
    heroLines: ["Guia do", "Auxilio Doenca", "INSS"],
    heroSub: "O que o seu medico precisa escrever no laudo para o INSS nao ter como negar.",
    painTitle: "Voce esta nessa situacao?",
    pains: [
      "Esta doente ou acidentado e nao sabe se tem direito ao auxilio",
      "O medico fez um laudo mas o INSS negou assim mesmo",
      "Tem medo de ir a pericia sem saber o que vai acontecer",
      "O beneficio foi cortado do nada e voce nao sabe o motivo",
    ],
    sectionLabel: "O que esta dentro do material",
    sectionTitle: "Conteudo que o INSS",
    sectionHighlight: "nao te conta.",
    items: [
      ...
      "O que pedir ao medico: a frase que muda tudo no laudo",
      "Como solicitar sem fila e sem sair de casa",
      "Se for negado: o prazo e o caminho para reverter",
    ],
    questions: [
      { question: "Qual e sua situacao hoje?", options: ["Ainda nao pedi o auxilio", "Estou aguardando analise", "Fui negado ou cortado"] },
      { question: "Voce tem laudo medico atualizado?", options: ["Sim, tenho", "Nao tenho ainda", "Tenho mas foi negado assim mesmo"] },
    ],
    whatsappTitle: "Para qual WhatsApp envio seu Guia do Auxilio Doenca?",
    keyword: "AUXILIO",
    footerProduct: "este guia",
  },
};
...
export function LeadMagnetLanding({ config }: { config: LeadMagnetLandingConfig }) {
  ...
  const submit = async (event: FormEvent) => {
    ...
    if (nums.length < 10) return setError("Informe um WhatsApp valido com DDD.");
  ...
  return (
    <main className="magnet-page">
        ...
        <div className="form-wrap">
          {success ? (
            <div className="success-box active">
              ...
              <p className="success-note">Duvidas? <a href="https://instagram.com/maiconmatos.adv" target="_blank" rel="noreferrer">@maiconmatos.adv</a></p>
            </div>
          ) : (
            <form onSubmit={submit}>
              ...
              {!isWhatsappStep ? (
                ...
                <div className="step active">
                  <div className="whatsapp-badge">Quase la - so falta o WhatsApp</div>
                  ...
                  <p className="form-note">Sem spam. Seus dados sao protegidos e nunca serao compartilhados.</p>
                </div>
              )}
            </form>
          )}
      ...
      <footer>
        <p><strong>Maicon Matos</strong> - Advogado Previdenciario | OAB/RS 136.221<br />
        Comenta <b>{config.keyword}</b> no Instagram e receba {config.footerProduct} gratuitamente.<br />
        Material educativo e informativo. Nao substitui orientacao juridica individualizada.<br />
...
const landingCss = `
  ...
  .magnet-page { --red:#CC0000; --red-dark:#8B0000; --black:#111; --white:#fff; --green:#25D366; font-family:'Barlow',sans-serif; background:var(--black); color:var(--white); min-height:100vh; overflow-x:hidden; }
  ...
  .hero h1 { font-family:'Bebas Neue',sans-serif; font-size:clamp(40px,9vw,75px); line-height:.95; color:#fff; max-width:800px; text-shadow:0 2px 20px rgba(0,0,0,.8); }
  .hero h1 span { color:var(--red); }
  .hero-sub { font-size:clamp(15px,2.5vw,19px); color:#D1D5DB; max-width:560px; margin:20px auto 0; line-height:1.6; font-style:italic; }
  .hero-cta { margin-top:36px; }
  .hero-cta a { display:inline-block; background:var(--red); color:var(--white); text-decoration:none; padding:16px 36px; border-radius:10px; font-family:'Bebas Neue',sans-serif; font-size:20px; letter-spacing:2px; box-shadow:0 4px 20px rgba(204,0,0,.35); }
  .pain { background:var(--red-dark); padding:60px 24px; text-align:center; }
  .pain h2 { font-family:'Bebas Neue',sans-serif; font-size:clamp(26px,5vw,44px); margin-bottom:36px; }
  .pain-grid { display:grid; grid-template-columns:repeat(auto-fit,minmax(220px,1fr)); gap:14px; max-width:860px; margin:0 auto; }
  .pain-item { background:rgba(0,0,0,.3); border:1px solid rgba(255,255,255,.08); border-radius:12px; padding:22px; text-align:left; }
  ...
  .teaser { background:var(--black); padding:80px 24px; }
  .teaser-inner { max-width:860px; margin:0 auto; }
  .section-label { font-weight:700; font-size:11px; letter-spacing:3px; text-transform:uppercase; color:var(--red); margin-bottom:10px; }
  .section-title { font-family:'Bebas Neue',sans-serif; font-size:clamp(30px,6vw,50px); line-height:1; margin-bottom:32px; }
  .section-title span { color:var(--red); }
  .items-list { display:flex; flex-direction:column; gap:10px; }
  .item-row { display:flex; align-items:center; gap:16px; background:#1A1A1A; border:1px solid #2A2A2A; border-radius:12px; padding:18px 20px; }
  .item-num { background:var(--red); color:var(--white); font-family:'Bebas Neue',sans-serif; font-size:17px; width:34px; height:34px; border-radius:8px; display:flex; align-items:center; justify-content:center; flex-shrink:0; }
  ...
  .step-question { font-family:'Bebas Neue',sans-serif; font-size:clamp(24px,5vw,34px); color:var(--white); margin-bottom:24px; line-height:1.1; }
  .options-grid { display:flex; flex-direction:column; gap:10px; margin-bottom:8px; }
  .option-btn { background:#1A1A1A; border:1.5px solid #333; border-radius:12px; padding:16px 20px; color:var(--white); font-family:'Barlow',sans-serif; font-size:15px; font-weight:600; cursor:pointer; text-align:left; display:flex; align-items:center; gap:12px; }
  ...
  .summary-box { background:#1A1A1A; border:1px solid #2A2A2A; border-radius:12px; padding:16px 20px; margin-bottom:24px; text-align:left; }
  ...
  .phone-input { flex:1; background:#1A1A1A; border:1px solid #333; border-radius:0 10px 10px 0; padding:14px 16px; font-family:'Barlow',sans-serif; font-size:16px; color:var(--white); outline:none; }
  .nome-input { width:100%; background:#1A1A1A; border:1px solid #333; border-radius:10px; padding:14px 18px; font-family:'Barlow',sans-serif; font-size:16px; color:var(--white); outline:none; }
  .btn-whatsapp { width:100%; background:var(--green); color:#000; border:none; border-radius:10px; padding:18px; font-family:'Bebas Neue',sans-serif; font-size:21px; letter-spacing:2px; cursor:pointer; margin-top:8px; }
  ...
  .success-box h3 { font-family:'Bebas Neue',sans-serif; font-size:34px; color:#4ADE80; margin-bottom:12px; }
  ...
  .author-band { background:var(--black); }
  .author { padding:60px 24px; max-width:700px; margin:0 auto; display:flex; align-items:center; gap:24px; flex-wrap:wrap; }
  .author-avatar { width:72px; height:72px; border-radius:50%; background:linear-gradient(135deg,var(--red-dark),var(--red)); display:flex; align-items:center; justify-content:center; font-size:24px; font-family:'Bebas Neue',sans-serif; flex-shrink:0; border:3px solid var(--red); }
  .author-info h3 { font-family:'Bebas Neue',sans-serif; font-size:24px; color:var(--white); margin-bottom:4px; }
