...
const ApiPublicZapsignWebhookRoute = ApiPublicZapsignWebhookRouteImport.update({
  id: '/api/public/zapsign-webhook', path: '/api/public/zapsign-webhook', getParentRoute: () => rootRouteImport,
} as any)
const ApiPublicWorkflowTickRoute = ApiPublicWorkflowTickRouteImport.update({
  id: '/api/public/workflow-tick', path: '/api/public/workflow-tick', getParentRoute: () => rootRouteImport,
} as any)
const ApiPublicWhatsappWebhookRoute = ApiPublicWhatsappWebhookRouteImport.update({
  id: '/api/public/whatsapp-webhook', path: '/api/public/whatsapp-webhook', getParentRoute: () => rootRouteImport,
} as any)
...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/clientes' | '/contratos' | '/dashboard' | '/funis' | '/inbox' | '/kanban' | '/login' | '/whatsapp' | '/api/public/whatsapp-webhook' | '/api/public/workflow-tick' | '/api/public/zapsign-webhook'
  fileRoutesByTo: FileRoutesByPath
  to: '/' | '/clientes' | '/contratos' | '/dashboard' | '/funis' | '/inbox' | '/kanban' | '/login' | '/whatsapp' | '/api/public/whatsapp-webhook' | '/api/public/workflow-tick' | '/api/public/zapsign-webhook'
  id: '__root__' | '/' | '/clientes' | '/contratos' | '/dashboard' | '/funis' | '/inbox' | '/kanban' | '/login' | '/whatsapp' | '/api/public/whatsapp-webhook' | '/api/public/workflow-tick' | '/api/public/zapsign-webhook'
  fileRoutesById: {
